...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    if pretrained:
        ...
        #此处换成自己的权重路径或使用上面注释掉的
        print('Use Pretrained Model of Resnet50')
        state_dict = torch.load("/public/home/G19940018/VideoGroup/SWB/code/pretrainedModel/resnet50.pth")
